...
function UserSignup () {
    ...
    return (
        <div className="page user-login p-7">
            ...
            <p className="text-center mb-7">Already have an account ? <Link to="/login" className="text-blue-600">Login</Link></p>
            <p className="text-center"><Link to="/captain-signup" className="text-blue-600">Signup as captain</Link></p>
        </div>
    )
}
