...
function CaptainLogin () {
    ...
    return (
        <div className="page user-login p-7">
            ...
            <p className="text-center mb-7">New here? <Link to="/captain-signup" className="text-blue-600">Create New Account</Link></p>
            <p className="text-center"><Link to="/login" className="text-blue-600">Login as Rider</Link></p>
        </div>
    )
}
